<form autocomplete="off" class="appForm clearfix" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="input_wrapper n50">
            ...
            <input class="form-control" placeholder="<?= $text_label_ded_resone ?>" required type="text" name="leavepermissionsReason" id="ExpenseName" maxlength="20" value="<?= $this->showValue('leavepermissionsReason') ?>">
        </div>
        <div class="mt-3">
