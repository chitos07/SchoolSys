<form autocomplete="off" class="appForm clearfix" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="">
            ...
            <input class="form-control" placeholder="<?= $text_label_ded_resone ?>" required type="text" name="missedoutsReason" id="ExpenseName" maxlength="20" value="<?= $this->showValue('missedoutsReason') ?>">
        </div>
        <div class="mt-3">
