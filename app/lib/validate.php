                    ...
                    if (preg_match_all('/(min)\((\d+)\)/', $validationRole, $m)) {
                        ...
                        if ($this->min($value, $m[2][0]) === false) {
                            $this->messenger->add(
                                ...
                                $this->languages->feedKey('text_error_' . $m[1][0], [$this->languages->get('text_label_' . $fieldName), $m[2][0]]),
                        ...
                        if ($this->between($value, $m[2][0], $m[3][0]) === false && !empty($value)  ) {


                            $this->messenger->add(

                                $this->languages->feedKey('text_error_' . $m[1][0], [$this->languages->get('text_label_' . $fieldName), $m[2][0], $m[3][0]]),
                        ...
                        if ($this->eq_field($value, $otherFieldValue) === false) {
                            $this->messenger->add(
                                $this->languages->feedKey('text_error_' . $m[1][0], [$this->languages->get('text_label_' . $fieldName), $this->languages->get('text_label_' . $m[2][0])]),
                                Messenger::APP_MESSAGE_ERROR
                            );
                        ...
                        if ($this->$validationRole($value) === false) {
                            ...
                            $this->messenger->add(
                                ...
                                $this->languages->feedKey('text_error_' . $validationRole, [$this->languages->get('text_label_' . $fieldName)]),
